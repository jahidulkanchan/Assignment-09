  ...
  return (
    <> 
       <section className="bg-slate-50 relative pb-20 min-h-[600px]">
        ...
        <form onSubmit={updateProfileData} className="profile-card flex flex-col justify-center items-center w-[350px] md:max-w-[400px] mx-auto absolute bottom-4 md:bottom-28 left-0 right-0 bg-white shadow-2xl min-h-[300px]">
