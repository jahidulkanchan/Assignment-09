...
const Login = () => {
  ...
  return (
    <>
      <section className="flex flex-col pb-10 pt-[80px] mt-[50px] bg-slate-50 justify-center min-h-[90vh] items-center">
        <h2 className="text-3xl text-center font-semibold mb-10"><span className="bg-gradient-to-r from-sky-500 to-indigo-500 bg-clip-text text-transparent">Log In</span> to Your Account</h2>
