...
const Register = () => {
  ...
  const { signUpUser, updateUserProfile, signWithGoogle, setUser } =
    ...
    <>
      ...
      <section className="flex flex-col bg-slate-50 justify-center pt-[50px] mt-[50px] min-h-[700px] sm:min-h-[600px] items-center">
        ...
        <form
          ...
          className="w-11/12 md:w-10/12 lg:w-8/12 bg-white py-8 flex flex-col justify-center items-center border space-y-4 shadow-md mx-auto min-h-[350px]"
        >
