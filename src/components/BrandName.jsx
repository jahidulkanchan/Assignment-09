      ...
      <Marquee gradient={false} speed={50} pauseOnHover={true}>
        {sliceBrands.map((brand, index) => (
          <div
            key={index}
            >
            <Link onClick={()=> window.scrollTo(0,0)} to={`/brand/${brand._id}`} className="card mx-5 my-5 shadow-md hover:shadow-lg duration-100 bg-slate-50 flex gap-5 items-center  px-8 py-3 md:py-5 border min-w-[200px] md:min-w-[300px] brand-name">
