  ...
  return (
    <>
      <section className="md:w-10/12 flex flex-col justify-center items-center mx-auto py-20">
        ...
        <div className="bg-gradient-to-r from-sky-500 to-indigo-500 rounded-2xl flex flex-col justify-center items-center shadow py-8 px-5 w-11/12 min-h-[300px] border">
