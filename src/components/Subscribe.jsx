...
const Subscribe = () => {
  return (
    <>
      <section className="md:w-10/12 flex justify-center items-center mx-auto py-20">
        <div className="bg-white flex flex-col justify-center items-center shadow py-8 px-5 w-11/12 min-h-[300px] border">
